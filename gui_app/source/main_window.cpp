...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent)
{
  ...
  renderAction->setShortcut(QKeySequence{"Ctrl+R"});
  resetAction->setShortcut(QKeySequence{"Ctrl+0"});
  previewAction->setShortcut(QKeySequence{"Ctrl+P"});
  flipSelectedAction->setShortcut(QKeySequence{"Ctrl+F"});
  removeSelectedTriangleAction->setShortcut(QKeySequence::Delete);
  fixVisibleNormalsAction->setShortcut(QKeySequence{"Ctrl+Shift+N"});
  editMaterialAction->setShortcut(QKeySequence{"Ctrl+M"});
  addLightAction->setShortcut(QKeySequence{"Ctrl+L"});
  editLightAction->setShortcut(QKeySequence{"Ctrl+Shift+L"});
  removeLightAction->setShortcut(QKeySequence{"Ctrl+Alt+L"});
  wireframe->setShortcut(QKeySequence{"Alt+W"});
  normals->setShortcut(QKeySequence{"Alt+N"});
  backfaceCulling->setShortcut(QKeySequence{"Alt+C"});
