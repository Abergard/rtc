...
inline auto operator!=(const math_point& p1, const math_point& p2) noexcept -> bool { return !(p1 == p2); }
...
constexpr inline auto operator+(const math_point& p1, const math_point& p2) noexcept -> math_point
{
...
constexpr inline auto operator/(const math_point& p1, const rtc_float c) noexcept -> math_point
{
  return {p1.x() / c, p1.y() / c, p1.z() / c};
}

constexpr inline auto operator<(const math_point& p1, const math_point& p2) noexcept -> bool
{
